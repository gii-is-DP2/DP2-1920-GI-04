...
INSERT IGNORE INTO beauty_services(id,title,type_id,vet_id,enabled,price) VALUES (1, 'Nail clipping', 1, 1, true, 10.0);
INSERT IGNORE INTO beauty_services(id,title,type_id,vet_id,enabled,price) VALUES (2, 'Full haircut', 1, 1, true, 10.0);
INSERT IGNORE INTO beauty_services(id,title,type_id,vet_id,enabled,price) VALUES (3, 'Modern haircut', 1, 1, true, 10.0);
INSERT IGNORE INTO beauty_services(id,title,type_id,vet_id,enabled,price) VALUES (4, 'Nail clipping', 2, 2, true, 30.0);
INSERT IGNORE INTO beauty_services(id,title,type_id,vet_id,enabled,price) VALUES (5, 'Nail clipping', 3, 1, true, 0.0);
INSERT IGNORE INTO beauty_services(id,title,type_id,vet_id,enabled,price) VALUES (6, 'Nail clipping', 4, 1, false, 99999.0);

INSERT IGNORE INTO beauty_service_visits(id,beauty_service_id,pet_id,date,final_price,cancelled) VALUES (1, 1, 1, '2013-01-01 22:00:00', 10.0, false);
